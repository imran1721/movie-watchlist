...
const Login = () => {
    ...
    const handleGuestEntry = () => {
        localStorage.setItem('user', JSON.stringify({ email: 'guest_entry', name: 'guest' }));
    ...
    return (
        <div className="flex flex-col m-auto justify-center bg-primary/10 h-screen">
            <div className="self-center items-center m-auto mt-20 border p-5 rounded-xl shadow bg-white">
                <div className="text-2xl font-bold text-primary">Welcome to Watchlist!</div>
                <div className="text-sm text-primary font-semibold mt-3">You can enter and register yourself using an email ID or just enter as guest.</div>
                <form className="mt-10">
                    <div className="grid grid-cols-4 mb-3">
                        <label className="col-span-1 m-auto font-semibold">Your Email</label>
                        <input
                            value={email}
