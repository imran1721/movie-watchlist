...
import { checkGreenIcon, checkIcon, checkWhiteIcon, watchlistWhiteIcon } from "../assets/icons"
    ...
    return (
        ...
        <div className="flex flex-col border rounded bg-gray-50" onClick={handleSelectedMovie}>
            ...
            <div className={`absolute w-12 h-12 z-10 ${!selectedWatchlist && "hidden"}`} onClick={handleWatched}>
                {movie.isWatched ?<img className="bg-black/20 w-10" src={checkGreenIcon} alt="Check mark Icon" /> : <img className="bg-black/20 w-10" src={checkWhiteIcon} alt="Check mark Icon" />}
            </div>
